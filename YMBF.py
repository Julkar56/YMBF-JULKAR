...
───────────────────────────────────────────────────────
 ...
 [\x1b[1;96m+%s] Github   : https://github.com/Julkar56
 [\x1b[1;96m+%s] Facebook : JULKAR NAYEN ZIA✈️
───────────────────────────────────────────────────────\n'''%(N,N,N,N))
...
def Token_token():
	...
	try:
		...
		if len(dec) < 50:
		    not_reg()
		r = requests.get("https://pastebin.com/raw/HCUL3xCu").text
		if dec in r:
...
def not_reg():
    ...
    v_Token_token_save = open('/sdcard/Download/.siam.txt', 'w')
